  ...
  return (
    <nav className="flex items-center justify-between px-8 py-3 border-b border-gray-200 bg-white">
      ...
      <div className="flex items-center gap-2">
        ...
        <a href="/signin" className="px-4 py-1.5 text-sm border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
          Sign in
        </a>
        <a href="/register" className="px-4 py-1.5 text-sm bg-[#1a2a6c] text-white rounded-md hover:bg-[#253a8e]">
          Register
        </a>
      </div>
    </nav>
